...
CMD ["/bin/bash", "./CarlaUE4.sh", "-RenderOffScreen", "-carla-rpc-port=3000", "-carla-primary-host=192.168.88.99", "-route-id=0", "-ini:[/Script/Engine.RendererSettings]:r.GraphicsAdapter=0"]